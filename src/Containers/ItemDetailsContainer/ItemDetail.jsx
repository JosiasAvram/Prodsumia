        ...
        <div className="text-center">
          ...
          {showComponent ? (
            <ItemCounter
              ...
              initial={1}
              onAdd={onAdd}
              cambiarBoton={setShowComponent}
            />
          ) : (
            <div>
              <p>{quantity > 1 ? `${alertmsg}es` : `${alertmsg}`}</p>
              <button className="border-2 border-slate-900 bg-teal-900 hover:bg-teal-800 py-3 text-white p-10 rounded-md mt-10">
